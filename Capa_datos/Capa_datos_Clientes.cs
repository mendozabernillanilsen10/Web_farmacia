...
{
    public class Capa_datos_Clientes
    {


        public DataTable CD_ListarClientes()
        {
            ...
            try
            {
                ...
                SqlCommand comando = new SqlCommand("Get_listaPersona", con);
        ...
        public int CD_ActulizarCliente(Persona user)
        {
            SqlConnection con = new SqlConnection();
            int i = -1;
            try
            {
                con = conexion.crearInstancia().crearConexion();
                SqlCommand cmd = new SqlCommand("sp_set_actualizardatosClientes", con);
        ...
        public int CD_InsertarCliente(Persona CEDatos)
        {
            int i = -1;
            SqlConnection con = new SqlConnection();
            try
            {
                con = conexion.crearInstancia().crearConexion();
                SqlCommand cmd = new SqlCommand("[dbo].[set_inserta_cliente]", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
        ...
        public int ActulizaEstado(estado es)
        {
            ...
            {
                con = conexion.crearInstancia().crearConexion();
                SqlCommand cmd = new SqlCommand("[dbo].[sp_set_actualizarEstadoCliente]", con);
                cmd.CommandType = CommandType.StoredProcedure;
