      ...
      <div class="modal-header">
       ...
       <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="number" class="form-control" id="precio" placeholder="Ingrese precio"><br>
                </div>

               <div class="col-lg-12">
                    <label for="">stock</label>
                    <input type="number" class="form-control" id="cantidad" placeholder="Ingrese stock"><br>
                </div>


                <div class="col-lg-12">
                        <label for="">Presentacion </label>
                        <input type="text" class="form-control" id="presentacion" placeholder="Ingrese presentacion"><br>
                </div>
