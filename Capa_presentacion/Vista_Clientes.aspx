...
<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Vista_Clientes.aspx.cs" Inherits="Capa_presentacion.Vista_Clientes" %>
    ...
    <div class="modal-content">
     ...
     <asp:Content ID="Content5" ContentPlaceHolderID="tipojs" runat="server">
         ...
         <script>
          ...
          <script src="scrip/Clientess.js"></script>  
