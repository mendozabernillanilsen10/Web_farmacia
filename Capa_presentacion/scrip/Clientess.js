...
function listar() {
    ...
    table = $("#example3").DataTable({
        ...
        "processing": true,
         ajax: {
            method: "POST",
            url: "Vista_Clientes.aspx/getUsers",
...
function ActulizarDatos() {
    ...
    $.ajax({
        method: "POST",
        url: "Vista_Clientes.aspx/actulizarCliente",
...
function Registrar() { 
    ...
    $.ajax({
        method: "POST",
        url: "Vista_Clientes.aspx/InsertarCliente",
        data: JSON.stringify(data),
        contentType: "application/json; charset=utf-8",
        dataType: "json"
    }).done(function (info) {
...
function Modificar_Estatus(id, id_estado) {
    ...
    $.ajax({
        method: "POST",
        url: "Vista_Clientes.aspx/actulizares",
        data: JSON.stringify(data),
        contentType: "application/json; charset=utf-8",
        dataType: "json"
    }).done(function (info) {
...
$(document).ready(function () {
    ...
    function cargarpais() {
        ...
        $.ajax({
            type: "POST",
            url: "Vista_Clientes.aspx/llenar",
            data: "{}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
    ...
    function cargarDepartamento(sendDatos) {
        ...
        $.ajax({
            type: "POST",
            url: "Vista_Clientes.aspx/llenarnarDe",
    ...
    function cargarProvincia(sendDatos) {
        ...
        $.ajax({
            type: "POST",
            url: "Vista_Clientes.aspx/llenarProvinvia",
            data: JSON.stringify(sendDatos),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (msg) {
    ...
    function cargarDistrito(sendDatos) {
        ...
        $.ajax({
            type: "POST",
            url: "Vista_Clientes.aspx/llenarDistrito",
            data: JSON.stringify(sendDatos),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (msg) {
    ...
    function cargarGenero() {
        ...
        $.ajax({
            type: "POST",
            url: "Vista_Clientes.aspx/llenarGenero",
            data: "{}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (msg) {
